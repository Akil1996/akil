        ...
        if row.type == ">150":
            if len(str(row.Su_Conc)) > 1:
                if df2["p1_degrees"][3] > df2["p2_degrees"][row_count-1]:
                    ...
                    Su_Dis_lst.append(temp)
                if df2["p1_degrees"][3] < df2["p2_degrees"][row_count-1]:
                    temp = df2["p2_degrees"][row_count-1] - (df2["p1_degrees"][0] + 210)
                    Su_Dis_lst.append(temp * -1)
            else:
                Su_Dis_lst.append(0)
            if len(str(row.Mo_Conc)) > 1:
                ...
                if df2["p1_degrees"][3] < df2["p2_degrees"][row_count - 1]:
                    Mo_Dis_lst.append((df2["p2_degrees"][row_count - 1] - (df2["p1_degrees"][1] + 210)) * -1)
            else:
                Mo_Dis_lst.append(0)
            if len(str(row.Me_Conc)) > 1:
                if (df2["p1_degrees"][3]) > (df2["p2_degrees"][row_count - 1]):
                ...
                if df2["p1_degrees"][3] < df2["p2_degrees"][row_count - 1]:
                    Me_Dis_lst.append((df2["p2_degrees"][row_count - 1] - (df2["p1_degrees"][2] + 210)) * -1)
            else:
                Me_Dis_lst.append(0)
            if len(str(row.Ma_Conc)) > 1:
                if df2["p1_degrees"][3] > df2["p2_degrees"][row_count - 1]:
                ...
                if df2["p1_degrees"][3] < df2["p2_degrees"][row_count - 1]:
                    Ma_Dis_lst.append((df2["p2_degrees"][row_count - 1] - (df2["p1_degrees"][3] + 210)) * -1)
            else:
                Ma_Dis_lst.append(0)
            if len(str(row.Ju_Conc)) > 1:
                if df2["p1_degrees"][3] > df2["p2_degrees"][row_count - 1]:
                ...
                if df2["p1_degrees"][3] < df2["p2_degrees"][row_count - 1]:
                    Ju_Dis_lst.append((df2["p2_degrees"][row_count - 1] - (df2["p1_degrees"][4] + 210)) * -1)
            else:
                Ju_Dis_lst.append(0)
            if len(str(row.Ve_Conc)) > 1:
                if df2["p1_degrees"][3] > df2["p2_degrees"][row_count - 1]:
                ...
                if df2["p1_degrees"][3] < df2["p2_degrees"][row_count - 1]:
                    Ve_Dis_lst.append((df2["p2_degrees"][row_count - 1] - (df2["p1_degrees"][5] + 210)) * -1)
            else:
                Ve_Dis_lst.append(0)
            if len(str(row.Sa_Conc)) > 1:
                if df2["p1_degrees"][3] > df2["p2_degrees"][row_count - 1]:
                ...
                if df2["p1_degrees"][3] < df2["p2_degrees"][row_count - 1]:
                    Sa_Dis_lst.append((df2["p2_degrees"][row_count - 1] - (df2["p1_degrees"][6] + 210)) * -1)
            else:
                Sa_Dis_lst.append(0)
            if len(str(row.Ra_Conc)) > 1:
                if df2["p1_degrees"][3] > df2["p2_degrees"][row_count - 1]:
                ...
                if df2["p1_degrees"][3] < df2["p2_degrees"][row_count - 1]:
                    Ra_Dis_lst.append((df2["p2_degrees"][row_count - 1] - (df2["p1_degrees"][7] + 210)) * -1)
            else:
                Ra_Dis_lst.append(0)
            if len(str(row.Ke_Conc)) > 1:
                if df2["p1_degrees"][3] > df2["p2_degrees"][row_count - 1]:
                ...
                if df2["p1_degrees"][3] < df2["p2_degrees"][row_count - 1]:
                    Ke_Dis_lst.append((df2["p2_degrees"][row_count - 1] - (df2["p1_degrees"][8] + 210))*  -1)
            else:
                Ke_Dis_lst.append(0)
            if len(str(row.As_Conc)) > 1:
                if df2["p1_degrees"][3] > df2["p2_degrees"][row_count - 1]:
                ...
                if df2["p1_degrees"][3] < df2["p2_degrees"][row_count - 1]:
                    As_Dis_lst.append((df2["p2_degrees"][row_count - 1] - (df2["p1_degrees"][9] + 210)) *-1)
            else:
                As_Dis_lst.append(0)
            if row_count == 10:
                row_count = 0
